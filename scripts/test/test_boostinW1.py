...
import test_util
from tree_influence.explainers import BoostInW1
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, BoostInW1, 'BoostInW1', kwargs)
    test_util.test_local_influence_binary(args, BoostInW1, 'BoostInW1', kwargs)
    test_util.test_local_influence_multiclass(args, BoostInW1, 'BoostInW1', kwargs)
