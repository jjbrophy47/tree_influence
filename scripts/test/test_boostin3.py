...
import test_util
from intent.explainers import BoostIn3
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, BoostIn3, 'BoostIn3', kwargs)
    test_util.test_local_influence_binary(args, BoostIn3, 'BoostIn3', kwargs)
    test_util.test_local_influence_multiclass(args, BoostIn3, 'BoostIn3', kwargs)
