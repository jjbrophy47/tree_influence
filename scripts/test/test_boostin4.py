...
import test_util
from intent.explainers import BoostIn4
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, BoostIn4, 'BoostIn4', kwargs)
    test_util.test_local_influence_binary(args, BoostIn4, 'BoostIn4', kwargs)
    test_util.test_local_influence_multiclass(args, BoostIn4, 'BoostIn4', kwargs)
