...
import test_util
from tree_influence.explainers import Target
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, Target, 'target', kwargs)
    test_util.test_local_influence_binary(args, Target, 'target', kwargs)
    test_util.test_local_influence_multiclass(args, Target, 'target', kwargs)
