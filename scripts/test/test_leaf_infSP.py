...
import test_util
from tree_influence.explainers import LeafInfluenceSP
...
def main(args):
    ...
    test_util.test_local_influence_binary(args, LeafInfluenceSP, 'LeafInfluenceSP', kwargs)
    test_util.test_local_influence_multiclass(args, LeafInfluenceSP, 'LeafInfluenceSP', kwargs)
