...
import test_util
from tree_influence.explainers import LeafSim
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, LeafSim, 'LeafSim', kwargs)
    test_util.test_local_influence_binary(args, LeafSim, 'LeafSim', kwargs)
    test_util.test_local_influence_multiclass(args, LeafSim, 'LeafSim', kwargs)
