...
import test_util
from intent.explainers import BoostIn2
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, BoostIn2, 'BoostIn2', kwargs)
    test_util.test_local_influence_binary(args, BoostIn2, 'BoostIn2', kwargs)
    test_util.test_local_influence_multiclass(args, BoostIn2, 'BoostIn2', kwargs)
