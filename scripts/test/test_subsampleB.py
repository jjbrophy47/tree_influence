...
import test_util
from intent.explainers import SubSampleB
...
def main(args):
    ...
    # tests
    test_util.test_local_influence_regression(args, SubSampleB, 'SubSampleB', kwargs)
    test_util.test_local_influence_binary(args, SubSampleB, 'SubSampleB', kwargs)
    test_util.test_local_influence_multiclass(args, SubSampleB, 'SubSampleB', kwargs)
