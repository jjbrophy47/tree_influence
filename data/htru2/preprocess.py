...
def main(test_size=0.2, seed=1):
    ...
    columns = ['mean_integrated_profile', 'sd_integrated_profile', 'kurtosis_integrated_profile',
              'skew_integrated_profile', 'mean_dmsnr', 'sd_dmsnr','kurtosis_dmsnr', 'skew_dmsnr', 'class']

    # retrieve dataset
    start = time.time()
    df = pd.read_csv('HTRU_2.csv', names=columns, header=None)
    ...
    features['numeric'] = ['mean_integrated_profile', 'sd_integrated_profile', 'kurtosis_integrated_profile',
                           'skew_integrated_profile', 'mean_dmsnr', 'sd_dmsnr','kurtosis_dmsnr', 'skew_dmsnr']
