...
def main(test_size=0.2, seed=1):
    ...
    df.columns = ['cement', 'blast_furnace', 'fly_ash', 'water', 'superplasticize',
                  'course_aggregate', 'fine_aggregate', 'age', 'compressive_strength']
    ...
    features = {}
    features['label'] = ['compressive_strength']
    features['numeric'] = ['cement', 'blast_furnace', 'fly_ash', 'water', 'superplasticize',
