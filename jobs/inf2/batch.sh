...
# ./jobs/inf2/primer.sh     $ddb $tt $mm  $tf $us1 $iol $lno $gos 3  1440    $ps  # minority
...
./jobs/inf2/primer.sh     $ddb $tt $mtx $tf $us1 $st2 $iol $lno $gos 9  1440    $ps  # trex
...
./jobs/inf2/primer.sh     $ddb $tt $mlo $tf $us1 $st2 $iol $lno $gos 7  1440  $ps  # loo
...
# ./jobs/inf2/primer.sh     $den $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $den $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
...
# ./jobs/inf2/primer.sh     $dfd $tt $mm  $tf $us1 $iol $lno $gos 3  1440    $ps  # minority
...
./jobs/inf2/primer.sh     $dfd $tt $mtx $tf $us1 $st2 $iol $lno $gos 5  1440    $ps  # trex
...
./jobs/inf2/primer.sh     $dfd $tt $mlo $tf $us1 $st2 $iol $lno $gos 7  1440  $ps  # loo
...
# ./jobs/inf2/primer.sh     $dgc $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dgc $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
...
# ./jobs/inf2/primer.sh     $dht $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
# ./jobs/inf2/primer.sh     $dlf $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dlf $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
...
# ./jobs/inf2/primer.sh     $dms $tt $mm  $tf $us1 $iol $lno $gos 20  1440    $ps  # minority
...
./jobs/inf2/primer.sh     $dms $tt $mb3 $tf $us1 $st2 $iol $lno $gos 20  1440    $ps  # boostin3
...
# ./jobs/inf2/primer.sh     $dms $tt $mtx $tf $us1 $st2 $iol $lno $goa 20  1440    $ps
./jobs/inf2/primer.sh     $dms $tt $mli $tf $us1 $st2 $iol $lno $gos 20  1440  $ps  # leaf_influence
./jobs/inf2/primer.sh     $dms $tt $mli $tf $us0 $st2 $iol $lno $gos 20  1440  $ps
...
# ./jobs/inf2/primer.sh     $dnv $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dnv $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
...
# ./jobs/inf2/primer.sh     $dns $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
# ./jobs/inf2/primer.sh     $dob $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
# ./jobs/inf2/primer.sh     $dpw $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dpw $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
...
# protein
./jobs/inf2/primer.sh     $dpr $tt $mr  $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # random
# ./jobs/inf2/primer.sh     $dpr $tt $mm  $tf $us1 $iol $lno $gos 3  1440    $ps  # minority
./jobs/inf2/primer.sh     $dpr $tt $mtg $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # target
./jobs/inf2/primer.sh     $dpr $tt $ms  $tf $us1 $st2 $iol $lno $gos 5  1440    $ps  # similarity
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # boostin
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lno $gos 3  1440    $ps
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lno $gos 3  1440    $ps
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lsg $gos 3  1440    $ps
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lsg $gos 3  1440    $ps
./jobs/inf2/primer.sh     $dpr $tt $mbi $tf $us1 $st2 $iol $lsg $gos 3  1440    $ps
./jobs/inf2/primer.sh     $dpr $tt $mb2 $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # boostin2
./jobs/inf2/primer.sh     $dpr $tt $mb3 $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # boostin3
./jobs/inf2/primer.sh     $dpr $tt $mb4 $tf $us1 $st2 $iol $lno $gos 3  1440    $ps  # boostin4
./jobs/inf2/primer.sh     $dpr $tt $mls $tf $us0 $st2 $iol $lno $gos 3  1440    $ps  # leaf_influenceSP
./jobs/inf2/primer.sh     $dpr $tt $mtx $tf $us1 $st2 $iol $lno $gos 5  1440    $ps  # trex
# ./jobs/inf2/primer.sh     $dpr $tt $mtx $tf $us1 $st2 $iol $lno $goe 6  1440    $ps
# ./jobs/inf2/primer.sh     $dpr $tt $mtx $tf $us1 $st2 $iol $lno $goa 3  1440    $ps
...
./jobs/inf2/primer.sh     $dpr $tt $mlo $tf $us1 $st2 $iol $lno $gos 7  1440  $ps  # loo
# ./jobs/inf2/primer.sh $dpr $tt $mlo $tf $us1 $st2 $iol $lno $goe 28 1440   $ps
./jobs/inf2/primer.sh     $dpr $tt $msb $tf $us1 $st2 $iol $lno $gos 7  1440  $ps  # subsample
...
# ./jobs/inf2/primer.sh     $dsb $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dsb $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $pl  # leaf_influence
...
# ./jobs/inf2/primer_mcu.sh $dsb $tt $mlo $tf $us1 $st2 $iol $lno $goe 28 600   $ps
./jobs/inf2/primer.sh     $dsb $tt $msb $tf $us1 $st2 $iol $lno $gos 5  1440  $ps  # subsample
# ./jobs/inf2/primer_mcu.sh $dsb $tt $mds $tf $us1 $st2 $iol $lno $gos 28 1440  $ps  # dshap
# ./jobs/inf2/primer_mcu.sh $dsb $tt $mds $tf $us1 $st2 $iol $lno $goe 28 1440  $ps

# surgical
./jobs/inf2/primer.sh     $dsg $tt $mr  $tf $us1 $st2 $iol $lno $gos 3  600    $ps  # random
# ./jobs/inf2/primer.sh     $dsg $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
# twitter
./jobs/inf2/primer.sh     $dtw $tt $mr  $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # random
# ./jobs/inf2/primer.sh     $dtw $tt $mm  $tf $us1 $iol $lno $gos 3  1440    $ps  # minority
./jobs/inf2/primer.sh     $dtw $tt $mtg $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # target
./jobs/inf2/primer.sh     $dtw $tt $ms  $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # similarity
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # boostin
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lno $gos 11  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lno $gos 11  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lsg $gos 11  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lsg $gos 11  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mbi $tf $us1 $st2 $iol $lsg $gos 11  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mb2 $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # boostin2
./jobs/inf2/primer.sh     $dtw $tt $mb3 $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # boostin3
./jobs/inf2/primer.sh     $dtw $tt $mb4 $tf $us1 $st2 $iol $lno $gos 11  1440    $ps  # boostin4
./jobs/inf2/primer.sh     $dtw $tt $mls $tf $us0 $st2 $iol $lno $gos 11  1440    $ps  # leaf_influenceSP
./jobs/inf2/primer.sh     $dtw $tt $mtx $tf $us1 $st2 $iol $lno $gos 28  1440    $ps  # trex
...
./jobs/inf2/primer.sh     $dtw $tt $mli $tf $us0 $st2 $iol $lno $gos 28  1440    $ps
./jobs/inf2/primer.sh     $dtw $tt $mlo $tf $us1 $st2 $iol $lno $gos 28  1440    $ps  # loo
# ./jobs/inf2/primer.sh $dtw $tt $mlo $tf $us1 $st2 $iol $lno $goe 28 600   $ps
./jobs/inf2/primer.sh     $dtw $tt $msb $tf $us1 $st2 $iol $lno $gos 28  1440    $ps  # subsample
...
# ./jobs/inf2/primer.sh     $dvc $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
# ./jobs/inf2/primer.sh     $dwn $tt $mm  $tf $us1 $iol $lno $gos 3  600    $ps  # minority
...
./jobs/inf2/primer.sh     $dwn $tt $mli $tf $us1 $st2 $iol $lno $gos 3  1440  $ps  # leaf_influence
