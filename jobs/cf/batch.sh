...
# xgb only
sbatch -a 7,9,22  -c 20  -t 4320 -p 'long'  -o ${o}${t}'_random-%a.out'     $run $t 'random'
sbatch -a 7,9,22  -c 20  -t 4320 -p 'long'  -o ${o}${t}'_target-%a.out'     $run $t 'target'
sbatch -a 22      -c 28  -t 2880 -p 'long'  -o ${o}${t}'_trex-%a.out'       $run $t 'trex'
sbatch -a 22      -c 28  -t 2880 -p 'long'  -o ${o}${t}'_subsample-%a.out'  $run $t 'subsample'

# sgb only
sbatch -a 7,9,14,15,22 -c 20 -t 4320 -p 'long'  -o ${o}${t}'_random-%a.out'     $run $t 'random'
sbatch -a 7,9,14,22    -c 20 -t 4320 -p 'long'  -o ${o}${t}'_target-%a.out'     $run $t 'target'
sbatch -a 22           -c 20 -t 1440 -p 'short' -o ${o}${t}'_leaf_infSP-%a.out' $run $t 'leaf_infSP'
sbatch -a 22           -c 28 -t 2880 -p 'long'  -o ${o}${t}'_trex-%a.out'       $run $t 'trex'
sbatch -a 7,9,15,22    -c 28 -t 2880 -p 'long'  -o ${o}${t}'_subsample-%a.out'  $run $t 'subsample'
...
# scratch pad
sbatch -a 6,8   -c 11 -t 1440 -p 'short' -o ${o}${t}'_leaf_inf-%a.out'   $run $t 'leaf_inf'
