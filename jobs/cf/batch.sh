...
sbatch -a 1-21                 -c 20 -t 1440 -p 'short' -o ${o}${t}'_target-%a.out'     $run $t 'target' $s
sbatch -a 1-21                 -c 15 -t 1440 -p 'short' -o ${o}${t}'_input_sim-%a.out'  $run $t 'input_sim' $s
...
sbatch -a 1-21                 -c 15 -t 1440 -p 'short' -o ${o}${t}'_leaf_infSP-%a.out' $run $t 'leaf_infSP' $s
sbatch -a 1-21                 -c 15 -t 1440 -p 'short' -o ${o}${t}'_trex-%a.out'       $run $t 'trex' $s
sbatch -a 1-6,8-10,14          -c 28 -t 1440 -p 'short' -o ${o}${t}'_subsample-%a.out'  $run $t 'subsample' $s
