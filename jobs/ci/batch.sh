./jobs/ci/primer.sh 'adult' 'lgb' 200 5 'random'         3  60    'short'
./jobs/ci/primer.sh 'adult' 'lgb' 200 5 'boostin'        3  60    'short'
./jobs/ci/primer.sh 'adult' 'lgb' 200 5 'trex'           3  60    'short'
./jobs/ci/primer.sh 'adult' 'lgb' 200 5 'leaf_influence' 7  10080 'short'
./jobs/ci/primer.sh 'adult' 'lgb' 200 5 'loo'            7  600   'short'

./jobs/ci/primer.sh 'bank_marketing' 'lgb' 50 5 'random'         3  60   'short'
./jobs/ci/primer.sh 'bank_marketing' 'lgb' 50 5 'boostin'        3  60   'short'
./jobs/ci/primer.sh 'bank_marketing' 'lgb' 50 5 'trex'           3  60   'short'
./jobs/ci/primer.sh 'bank_marketing' 'lgb' 50 5 'leaf_influence' 7  2880 'long'
./jobs/ci/primer.sh 'bank_marketing' 'lgb' 50 5 'loo'            7  600  'short'

./jobs/ci/primer.sh 'surgical' 'lgb' 50 7 'random'         3  60  'short'
./jobs/ci/primer.sh 'surgical' 'lgb' 50 7 'boostin'        3  60  'short'
./jobs/ci/primer.sh 'surgical' 'lgb' 50 7 'trex'           3  60  'short'
./jobs/ci/primer.sh 'surgical' 'lgb' 50 7 'leaf_influence' 7  600 'short'
./jobs/ci/primer.sh 'surgical' 'lgb' 50 7 'loo'            7  600 'short'
./jobs/ci/primer_multi_cpu.sh 'surgical' 'lgb' 50 7 'dshap'         0.5  28  1440 'short'
./jobs/ci/primer_multi_cpu.sh 'surgical' 'lgb' 50 7 'dshap'         0.75 28  1440 'short'
