...
./jobs/ci/primer.sh $d1 $tt $nt1 $md1 $m5 $tf $go1 $io2 6  600   $p1  # loo
./jobs/ci/primer.sh $d1 $tt $nt1 $md1 $m5 $tf $go2 $io0 6  600   $p1
...
./jobs/ci/primer.sh $d2 $tt $nt2 $md2 $m5 $tf $go1 $io2 6  600   $p1  # loo
./jobs/ci/primer.sh $d2 $tt $nt2 $md2 $m5 $tf $go2 $io0 6  600   $p1
...
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m3 $tf $go1 $io2 6  60    $p1  # trex
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m3 $tf $go2 $io0 15 60    $p1
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m3 $tf $go3 $io0 3  60    $p1
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m4 $tf $go1 $io2 3  10080 $p2  # leaf_influence
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m5 $tf $go1 $io2 6  600   $p1  # loo
./jobs/ci/primer.sh $d5 $tt $nt5 $md5 $m5 $tf $go2 $io0 6  600   $p1
