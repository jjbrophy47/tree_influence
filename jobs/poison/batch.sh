...
# cb only
sbatch -a 1-3,5,8-10         -c 20 -t 1440 -p 'short' -o ${o}${t}'_subsample-%a.out'  $run $t 'subsample'
sbatch -a 7,9,11,13-15,18-19 -c 20 -t 1440 -p 'short' -o ${o}${t}'_subsample-%a.out'  $run $t 'subsample'
...
sbatch -a 3                  -c 28 -t 2880 -p 'long'  -o ${o}${t}'_leaf_inf-%a.out'   $run $t 'leaf_inf'
sbatch -a 3                  -c 28 -t 2880 -p 'long'  -o ${o}${t}'_leaf_refit-%a.out' $run $t 'leaf_refit'
