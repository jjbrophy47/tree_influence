...
./jobs/ru/primer.sh $dns $tt $mlo $tf $us1 3  1440  $ps  # loo
...
./jobs/ru/primer.sh $dob $tt $mlo $tf $us1 3  1440  $ps  # loo
...
./jobs/ru/primer.sh $dtw $tt $msb $tf $us1 3  1440  $ps  # subsample
