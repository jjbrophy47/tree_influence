...
./jobs/ru/primer.sh $dad $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dad $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dbm $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dbm $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dbn $tt $mlo $tf $us1 5  600  $ps  # loo
./jobs/ru/primer.sh $dbn $tt $msb $tf $us1 5  600  $ps  # subsample
...
./jobs/ru/primer.sh $dco $tt $mlo $tf $us1 5  600  $ps  # loo
./jobs/ru/primer.sh $dco $tt $msb $tf $us1 5  600  $ps  # subsample
...
./jobs/ru/primer.sh $dcn $tt $mlo $tf $us1 5  600  $ps  # loo
./jobs/ru/primer.sh $dcn $tt $msb $tf $us1 5  600  $ps  # subsample
...
./jobs/ru/primer.sh $dcc $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dcc $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $ddb $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $ddb $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $den $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $den $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dfd $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dfd $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dgc $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dgc $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dht $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dht $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dlf $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dlf $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dms $tt $mtx $tf $us1 20  1440  $ps  # trex
./jobs/ru/primer.sh $dms $tt $mlo $tf $us1 20  1440  $ps  # loo
./jobs/ru/primer.sh $dms $tt $msb $tf $us1 20  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dnv $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dnv $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dns $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dns $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dob $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dob $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dpw $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dpw $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dpr $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dpr $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dsb $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dsb $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dsg $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dsg $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dtw $tt $mtx $tf $us1 6  1440  $ps  # trex
./jobs/ru/primer.sh $dtw $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dtw $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dvc $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dvc $tt $msb $tf $us1 5  1440  $ps  # subsample
...
./jobs/ru/primer.sh $dwn $tt $mlo $tf $us1 5  1440  $ps  # loo
./jobs/ru/primer.sh $dwn $tt $msb $tf $us1 5  1440  $ps  # subsample
