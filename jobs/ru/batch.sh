...
sbatch -a 22-22  -c 5  -t 1440 -p 'short' -o ${o}${t}'_leaf_sim-%a.out'   $run $t 'leaf_sim'
sbatch -a 22-22  -c 5  -t 1440 -p 'short' -o ${o}${t}'_boostin-%a.out'    $run $t 'boostin'
sbatch -a 22-22  -c 5  -t 1440 -p 'short' -o ${o}${t}'_leaf_infSP-%a.out' $run $t 'leaf_infSP'
...
for seed in ${seed_list[@]}; do
    ...
    sbatch -a 14,15,17         -c 3  -t 1440 -p 'short' -o ${o}${t}'_loo-%a.out'       $run2 $t 'loo'       $seed
    sbatch -a 7,9              -c 3  -t 2880 -p 'long'  -o ${o}${t}'_loo-%a.out'       $run2 $t 'loo'       $seed
    sbatch -a 22-22            -c 3  -t 7200 -p 'long'  -o ${o}${t}'_loo-%a.out'       $run2 $t 'loo'       $seed
