...
./jobs/inf/primer.sh     $dad $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dbn $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dco $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dcn $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $den $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dgc $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dht $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dlf $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dnv $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dpw $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dsb $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dsg $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dvc $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
...
./jobs/inf/primer.sh     $dwn $tt $ms  $tf $us1 $sc1 $iol $lno $gos 3  600    $ps  # similarity2
